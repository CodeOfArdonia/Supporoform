...
public abstract class PageContent {
    ...
    public void addTitle(ArrayList<BookElement> list, String titleText, boolean dropShadow, int color, int y) {
        ...
        if (this.isCentered()) {
            w = (int) Math.ceil(this.parent.parent.parent.fontRenderer.getWidth(titleText) * title.scale) + 1;
    ...
    public int addText(ArrayList<BookElement> list, String text, boolean dropShadow, int color, int y) {
        ...
        int height = this.parent.parent.parent.fontRenderer.getWrappedLinesHeight(text, BookScreen.PAGE_WIDTH) * 12 / 9;
