...
public class ContentStructure extends PageContent {
    ...
    public static final Identifier ID = Mantle.getResource("structure");
    ...
    public void load() {
        ...
        try {
            NbtCompound compoundnbt = NbtIo.readCompressed(resource.getInputStream());
            this.template.readNbt(Registries.BLOCK.getReadOnlyWrapper(), compoundnbt);
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
    ...
    public void build(BookData book, ArrayList<BookElement> list, boolean rightSide) {
        ...
        if (this.template != null && this.template.getSize() != BlockPos.ORIGIN) {
