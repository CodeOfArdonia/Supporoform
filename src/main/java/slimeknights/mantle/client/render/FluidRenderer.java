...
public class FluidRenderer {
    ...
    public static Sprite getBlockSprite(Identifier sprite) {
        return MinecraftClient.getInstance().getBakedModelManager().getAtlas(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE).getSprite(sprite);
    }
    ...
    public static void renderCuboids(MatrixStack matrices, VertexConsumer buffer, List<FluidCuboid> cubes, FluidStack fluid, int light) {
        ...
        Sprite still = getBlockSprite(clientFluid.getStillTexture(fluid));
        Sprite flowing = getBlockSprite(clientFluid.getFlowingTexture(fluid));
