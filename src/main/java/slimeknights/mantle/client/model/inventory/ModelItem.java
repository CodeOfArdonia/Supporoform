...
public class ModelItem {
    ...
    @Getter
    private final ModelTransformationMode transform;
    ...
    public ModelItem(Vector3f center, float size, float x, float y) {
        this(center, size, x, y, ModelTransformationMode.NONE);
    }
     ...
     */
    private static ModelTransformationMode parseTransformType(JsonObject json, String key) {
        String name = net.minecraft.util.JsonHelper.getString(json, key, "none");
        for (ModelTransformationMode type : ModelTransformationMode.values()) {
            if (name.equals(type.asString())) {
                return type;
            }
        }
    ...
    public static ModelItem fromJson(JsonObject json) {
        ...
        ModelTransformationMode transformType = parseTransformType(json, "transform");
