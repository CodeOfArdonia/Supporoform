...
public class Mantle {
    ...
    private void register(RegisterEvent event) {
        ...
        if (key == RegistryKeys.RECIPE_SERIALIZER) {
            ...
            // predicates
            {
                ...
                // register mob types
                MobTypePredicate.MOB_TYPES.register(new Identifier("undefined"), EntityGroup.DEFAULT);
                MobTypePredicate.MOB_TYPES.register(new Identifier("undead"), EntityGroup.UNDEAD);
                MobTypePredicate.MOB_TYPES.register(new Identifier("arthropod"), EntityGroup.ARTHROPOD);
                MobTypePredicate.MOB_TYPES.register(new Identifier("illager"), EntityGroup.ILLAGER);
                MobTypePredicate.MOB_TYPES.register(new Identifier("water"), EntityGroup.AQUATIC);
        ...
        } else if (key == RegistryKeys.BLOCK_ENTITY_TYPE) {
    ...
    public static String makeDescriptionId(String base, String name) {
        return Util.createTranslationKey(base, getResource(name));
    }
     ...
     * @return Translation key
     */
    public static MutableText makeComponent(String base, String name) {
        return Text.translatable(makeDescriptionId(base, name));
    }
}
