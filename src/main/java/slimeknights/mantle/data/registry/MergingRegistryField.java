 ...
 */
public record MergingRegistryField<T extends IHaveLoader, P>(Loadable<T> loadable, String typeKey,
    ...
    public static void mapType(JsonObject json, String typeKey) {
        json.addProperty("type", JsonHelper.getString(json, typeKey));
        json.remove(typeKey);
    }
    ...
    public T get(JsonObject json) {
        ...
        return this.loadable.convert(json, "[unknown]");
    }

    @Override
    public void serialize(P parent, JsonObject json) {
        serializeInto(json, this.typeKey, this.loadable, this.getter.apply(parent));
    }
}
