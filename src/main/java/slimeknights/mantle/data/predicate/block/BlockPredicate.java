...
public interface BlockPredicate extends IJsonPredicate<BlockState> {
     ...
     */
    RegistryPredicateRegistry<Block, BlockState> LOADER = new RegistryPredicateRegistry<>("Block Predicate", ANY, Loadables.BLOCK, BlockState::getBlock, "blocks", Loadables.BLOCK_TAG, (tag, state) -> state.isIn(tag));
     ...
     */
    BlockPredicate REQUIRES_TOOL = simple(AbstractBlockState::isToolRequired);
