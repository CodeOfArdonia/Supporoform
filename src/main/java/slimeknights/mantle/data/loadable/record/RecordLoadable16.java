...
record RecordLoadable16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, R>(
    ...
    public R deserialize(JsonObject json, TypedMap context) {
        return this.constructor.apply(
                ...
                this.fieldO.get(json, context),
                this.fieldP.get(json, context)
        );
    }
    ...
    public void serialize(R object, JsonObject json) {
        ...
        this.fieldO.serialize(object, json);
        this.fieldP.serialize(object, json);
    }
    ...
    public R decode(PacketByteBuf buffer, TypedMap context) {
        return this.constructor.apply(
                ...
                this.fieldO.decode(buffer, context),
                this.fieldP.decode(buffer, context)
        );
    }
    ...
    public void encode(PacketByteBuf buffer, R object) {
        ...
        this.fieldO.encode(buffer, object);
        this.fieldP.encode(buffer, object);
    }
}
