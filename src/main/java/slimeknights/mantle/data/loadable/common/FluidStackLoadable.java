...
public class FluidStackLoadable {
     ...
     */
    private static final LoadableField<NbtCompound, FluidStack> NBT = NBTLoadable.ALLOW_STRING.nullableField("nbt", FluidStack::getTag);
     ...
     */
    private static FluidStack makeStack(Fluid fluid, int amount, @Nullable NbtCompound nbt) {
