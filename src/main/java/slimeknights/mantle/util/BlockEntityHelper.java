...
public class BlockEntityHelper {
     ...
     * @return Optional of the tile entity, empty if missing or wrong class
     */
    public static <T> Optional<T> get(Class<T> clazz, @Nullable BlockView world, BlockPos pos, boolean logWrongType) {
     ...
     */
    @Nullable
    public static <HAVE extends BlockEntity, RET extends BlockEntity> BlockEntityTicker<RET> serverTicker(World level, BlockEntityType<RET> expected, BlockEntityType<HAVE> have, BlockEntityTicker<? super HAVE> ticker) {
        return level.isClient ? null : castTicker(expected, have, ticker);
    }
}
