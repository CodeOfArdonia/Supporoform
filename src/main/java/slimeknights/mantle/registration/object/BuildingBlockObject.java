...
public class BuildingBlockObject extends ItemObject<Block> {
    ...
    public BuildingBlockObject(Block block, Block slab, Block stairs) {
        super(Registries.BLOCK, block);
        this.slab = RegistrationHelper.getCastedHolder(Registries.BLOCK, slab);
        this.stairs = RegistrationHelper.getCastedHolder(Registries.BLOCK, stairs);
    }
