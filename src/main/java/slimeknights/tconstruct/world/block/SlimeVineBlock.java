...
public class SlimeVineBlock extends VineBlock {
    ...
    public SlimeVineBlock(Settings properties, SlimeType foliage) {
        super(properties);
    ...
    private BlockState updateConnections(BlockState state, BlockView world, BlockPos pos) {
        ...
        for (Direction direction : Direction.Type.HORIZONTAL) {
            BooleanProperty prop = getFacingProperty(direction);
            if (state.get(prop)) {
                state = state.with(prop, this.hasAttachment(world, pos, direction));
            }
        }
     ...
     */
    private boolean hasAttachment(BlockView world, BlockPos pos, Direction side) {
