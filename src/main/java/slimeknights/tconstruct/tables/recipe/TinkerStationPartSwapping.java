...
public class TinkerStationPartSwapping implements ITinkerStationRecipe {
    ...
    public boolean matches(ITinkerStationContainer inv, World world) {
        ...
        if (tinkerable.isEmpty() || !tinkerable.isIn(TinkerTags.Items.MULTIPART_TOOL) || !(tinkerable.getItem() instanceof IModifiable modifiable)) {
            return false;
        }
    ...
    /**
     * @deprecated Use {@link #craft(ITinkerStationContainer, DynamicRegistryManager)}
     */
    @Deprecated
    @Override
