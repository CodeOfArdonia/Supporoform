...
public final class TinkerTables extends TinkerModule {
     ...
     * Blocks
     */
    private static final Block.Properties WOOD_TABLE = builder(Material.WOOD, BlockSoundGroup.WOOD).strength(1.0F, 5.0F).noOcclusion();
    /**
    ...
    private static final Block.Properties METAL_TABLE = builder(Material.HEAVY_METAL, BlockSoundGroup.ANVIL).requiresCorrectToolForDrops().strength(5.0F, 1200.0F).noOcclusion();
    ...
    private static final Block.Properties STONE_TABLE = builder(Material.STONE, BlockSoundGroup.METAL).requiresCorrectToolForDrops().strength(3.0F, 9.0F).noOcclusion();
     ...
     * Containers
     */
    public static final RegistryObject<ScreenHandlerType<CraftingStationContainerMenu>> craftingStationContainer = MENUS.register("crafting_station", CraftingStationContainerMenu::new);
    public static final RegistryObject<ScreenHandlerType<TinkerStationContainerMenu>> tinkerStationContainer = MENUS.register("tinker_station", TinkerStationContainerMenu::new);
    public static final RegistryObject<ScreenHandlerType<PartBuilderContainerMenu>> partBuilderContainer = MENUS.register("part_builder", PartBuilderContainerMenu::new);
    public static final RegistryObject<ScreenHandlerType<ModifierWorktableContainerMenu>> modifierWorktableContainer = MENUS.register("modifier_worktable", ModifierWorktableContainerMenu::new);
    public static final RegistryObject<ScreenHandlerType<TinkerChestContainerMenu>> tinkerChestContainer = MENUS.register("tinker_chest", TinkerChestContainerMenu::new);
