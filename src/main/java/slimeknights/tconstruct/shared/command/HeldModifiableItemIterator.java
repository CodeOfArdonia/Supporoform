...
public class HeldModifiableItemIterator {
     ...
     */
    public static List<LivingEntity> apply(CommandContext<ServerCommandSource> context, HeldModifiableBehavior behavior) throws CommandSyntaxException {
        return apply(EntityArgumentType.getEntities(context, "targets"), behavior);
    }
