...
public class SlotTypeArgument implements ArgumentType<OptionalSlotType> {
    ...
    private static final DynamicCommandExceptionType SLOT_TYPE_NOT_FOUND = new DynamicCommandExceptionType(name -> Text.translatable("command.tconstruct.slot_type.not_found", name));
     ...
     */
    public static OptionalSlotType getOptional(CommandContext<ServerCommandSource> context, String name) {
     ...
     * Gets a modifier from the command context
     */
    public static SlotType getSlotType(CommandContext<ServerCommandSource> context, String name) throws CommandSyntaxException {
