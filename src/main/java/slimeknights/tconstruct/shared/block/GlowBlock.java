...
public class GlowBlock extends Block {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView worldIn, BlockPos pos, ShapeContext context) {
        return Objects.requireNonNull(BOUNDS.get(state.get(FACING)));
    }
    ...
    protected boolean canBlockStay(World world, BlockPos pos, Direction facing) {
        ...
        boolean isSolidSide = Block.isFaceFullSquare(world.getBlockState(placedOn).getCullingShape(world, pos), facing.getOpposite());
    ...
    public boolean addGlow(World world, BlockPos pos, Direction direction) {
        ...
        if (state.getBlock() != this && state.isReplaceable()) {
