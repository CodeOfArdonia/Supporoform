...
public enum SlimeType implements StringIdentifiable {
    EARTH(0x01cd4e, MapColor.GREEN, false),
    SKY(0x01cbcd, MapColor.DIAMOND_BLUE, false),
    ICHOR(0xff970d, MapColor.ORANGE, true, 10),
    ENDER(0xaf4cf6, MapColor.PURPLE, false);
    ...
    SlimeType(int color, MapColor mapColor, boolean nether, int lightLevel) {
        ...
        // tags
        this.slimeballTag = TinkerTags.Items.forgeTag("slimeball/" + this.asString());
    }
