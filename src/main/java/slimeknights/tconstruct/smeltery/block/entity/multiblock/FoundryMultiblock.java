...
public class FoundryMultiblock extends HeatingStructureMultiblock<FoundryBlockEntity> {
    ...
    protected boolean isValidBlock(Block block) {
        return block.getRegistryEntry().isIn(TinkerTags.Blocks.FOUNDRY);
    }

    @SuppressWarnings("deprecation")
    @Override
    protected boolean isValidFloor(Block block) {
        return block.getRegistryEntry().isIn(TinkerTags.Blocks.FOUNDRY_FLOOR);
    }

    @SuppressWarnings("deprecation")
    @Override
    protected boolean isValidTank(Block block) {
        return block.getRegistryEntry().isIn(TinkerTags.Blocks.FOUNDRY_TANKS);
    }

    @SuppressWarnings("deprecation")
    @Override
    protected boolean isValidWall(Block block) {
        return block.getRegistryEntry().isIn(TinkerTags.Blocks.FOUNDRY_WALL);
    }
}
