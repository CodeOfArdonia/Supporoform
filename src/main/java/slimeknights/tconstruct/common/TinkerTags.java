...
public class TinkerTags {
    ...
    public static class Blocks {
        ...
        // ceramics compat
        public static final TagKey<Block> CISTERN_CONNECTIONS = TagKey.of(RegistryKeys.BLOCK, new Identifier("ceramics", "cistern_connections"));

        /**
         * Makes a tag in the tinkers domain
         */
        public static TagKey<Block> tag(String name) {
            return TagKey.of(RegistryKeys.BLOCK, TConstruct.getResource(name));
        }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return TagKey.of(RegistryKeys.ITEM, TConstruct.getResource(name));
        }
    ...
    public static class Fluids {
        ...
        private static TagKey<Fluid> tag(String name) {
            return TagKey.of(RegistryKeys.FLUID, TConstruct.getResource(name));
        }
    }
    ...
    public static class EntityTypes {
        ...
        private static TagKey<EntityType<?>> tag(String name) {
            return TagKey.of(RegistryKeys.ENTITY_TYPE, TConstruct.getResource(name));
        }

        private static TagKey<EntityType<?>> forgeTag(String name) {
            return TagKey.of(RegistryKeys.ENTITY_TYPE, new Identifier("forge", name));
        }
    }
    ...
    public static class TileEntityTypes {
        ...
        private static TagKey<BlockEntityType<?>> tag(String name) {
            return TagKey.of(RegistryKeys.BLOCK_ENTITY_TYPE, TConstruct.getResource(name));
        }
    }
    ...
    public static class Biomes {
        ...
        private static TagKey<Biome> tag(String name) {
            return TagKey.of(RegistryKeys.BIOME, TConstruct.getResource(name));
        }
    }
