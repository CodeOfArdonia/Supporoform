...
public class TinkerLoadables {
    ...
    public static final StringLoadable<LightType> LIGHT_LAYER = new EnumLoadable<>(LightType.class);
    ...
    /* Registries */
    public static final StringLoadable<Identifier> CUSTOM_STAT = new RegistryLoadable<>(Registry.CUSTOM_STAT);
