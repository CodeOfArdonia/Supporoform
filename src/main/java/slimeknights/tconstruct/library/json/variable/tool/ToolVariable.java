...
public interface ToolVariable extends IHaveLoader, MeleeVariable, ConditionalStatVariable {
    GenericLoaderRegistry<ToolVariable> LOADER = new VariableLoaderRegistry<>("Tool Variable", Constant::new);
     ...
     */
    static void register(Identifier name, IGenericLoader<? extends ToolVariable> loader) {
