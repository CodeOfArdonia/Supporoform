...
public class ToolHarvestContext {
    ...
    public ToolHarvestContext forPosition(BlockPos pos, BlockState state) {
        return new ToolHarvestContext(this.world, this.living, this.player, state, pos, this.sideHit, state.canHarvestBlock(this.world, pos, this.player), true, true, this.targetedPos, this.targetedState);
    }
}
