...
public class PersistentDataCapability {
    ...
    private static void attachCapability(AttachCapabilitiesEvent<Entity> event) {
        ...
        if (entity instanceof PlayerEntity || EntityModifierCapability.supportCapability(entity)) {
     ...
     */
    private static class Provider implements ICapabilitySerializable<NbtCompound>, Runnable {
        private Lazy<NbtCompound> nbt;
        private LazyOptional<NamespacedNBT> capability;

        private Provider() {
            this.nbt = Lazy.of(NbtCompound::new);
