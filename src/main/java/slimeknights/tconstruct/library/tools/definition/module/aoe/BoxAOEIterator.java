...
public record BoxAOEIterator(BoxSize base, List<BoxSize> expansions,
     ...
     */
    public static Iterable<BlockPos> calculate(IToolStackView tool, ItemStack stack, World world, PlayerEntity player, BlockPos origin, Direction sideHit, BoxSize extraSize, IBoxExpansion expansionDirection, AOEMatchType matchType) {
        // skip if no work
        if (extraSize.isZero()) {
    ...
    public static class Builder {
        ...
        public BoxAOEIterator build() {
            return new BoxAOEIterator(base, expansions.build(), this.direction);
        }
    }
}
