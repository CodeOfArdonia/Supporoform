...
public class ToolDefinitionDataBuilder {
    ...
    public ToolDefinitionDataBuilder smallToolStartingSlots() {
        this.module(new ToolSlotsModule(ImmutableMap.of(SlotType.UPGRADE, 3, SlotType.ABILITY, 1)));
        return this;
    }
    ...
    public ToolDefinitionDataBuilder largeToolStartingSlots() {
        this.module(new ToolSlotsModule(ImmutableMap.of(SlotType.UPGRADE, 2, SlotType.ABILITY, 1)));
        return this;
    }
    ...
    public final <T extends ToolModule> ToolDefinitionDataBuilder module(T module, ModuleHook<? super T>... hooks) {
        this.modules.add(new WithHooks<>(module, List.of(hooks)));
        return this;
    }
    ...
    public ToolDefinitionDataBuilder module(ToolModule module) {
        this.modules.add(new WithHooks<>(module, List.of()));
        return this;
    }
