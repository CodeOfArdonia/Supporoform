...
public class StationSlotLayout {
     ...
     */
    public static StationSlotLayout read(PacketByteBuf buffer) {
    ...
    public void write(PacketByteBuf buffer) {
        ...
        buffer.writeString(this.getTranslationKey());
     ...
     */
    private transient Text displayName = null;
    /**
     * Cache of display name
     */
    private transient Text description = null;
    ...
    public Text getDisplayName() {
        if (this.displayName == null) {
            this.displayName = Text.translatable(this.getTranslationKey());
        }
    ...
    public Text getDescription() {
        if (this.description == null) {
            this.description = Text.translatable(this.getTranslationKey() + ".description");
        }
    ...
    public static class Builder {
         ...
         */
        public Builder addInputItem(Pattern icon, ItemConvertible item, int x, int y) {
            return this.addInputSlot(icon, item.asItem().getTranslationKey(), x, y, Ingredient.ofItems(item));
        }

        /**
         * Adds an input as the given item
         */
        public Builder addInputItem(ItemConvertible item, int x, int y) {
            return this.addInputItem(new Pattern(Registries.ITEM.getId(item.asItem())), item, x, y);
        }
        ...
        public Builder addInputPattern(Pattern icon, int x, int y, Ingredient ingredient) {
            return this.addInputSlot(icon, icon.getTranslationKey(), x, y, ingredient);
        }
