...
import static net.minecraft.client.texture.NativeImage.combine;
import static net.minecraft.client.texture.NativeImage.getA;
import static net.minecraft.client.texture.NativeImage.getB;
import static net.minecraft.client.texture.NativeImage.getG;
import static net.minecraft.client.texture.NativeImage.getR;
    ...
    protected static class Deserializer implements JsonDeserializer<GreyToColorMapping> {
        ...
        public GreyToColorMapping deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            for (int i = 0; i < palette.size(); i++) {
                ...
                int color = JsonHelper.parseColor(net.minecraft.util.JsonHelper.getString(palettePair, "color"));
                if (i == 0 && grey != 0) {
