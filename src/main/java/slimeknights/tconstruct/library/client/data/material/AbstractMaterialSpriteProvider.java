...
public abstract class AbstractMaterialSpriteProvider {
    ...
    protected MaterialSpriteInfoBuilder buildMaterial(MaterialId name) {
        return this.buildMaterial((Identifier) name);
    }
    ...
    public static class MaterialSpriteInfo extends MaterialGeneratorJson {
        ...
        public MaterialSpriteInfo(Identifier texture, String[] fallbacks, MaterialGeneratorJson generatorJson) {
            super(generatorJson);
            this.texture = texture;
            this.fallbacks = fallbacks;
        }

        public MaterialSpriteInfo(Identifier texture, String[] fallbacks, ISpriteTransformer transformer, Set<MaterialStatsId> supportedStats) {
