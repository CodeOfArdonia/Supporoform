...
public class TinkerBook extends BookData {
    ...
    public static void initBook() {
        BookLoader.registerGsonTypeAdapter(Text.class, new Text.Serializer());
     ...
     * @param id   Book ID
     */
    private static void addStandardData(BookData book, Identifier id) {
        book.addRepository(new FileRepository(new Identifier(id.getNamespace(), "book/" + id.getPath())));
