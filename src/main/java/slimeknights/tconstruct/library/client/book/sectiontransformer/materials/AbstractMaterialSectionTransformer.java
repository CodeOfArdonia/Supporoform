...
public abstract class AbstractMaterialSectionTransformer extends SectionTransformer {
    ...
    protected AbstractMaterialContent getPageContent(MaterialVariantId material) {
        return new MeleeHarvestMaterialContent(material, this.detailed);
    }
     ...
     */
    private static PageData addPageStatic(SectionData data, String name, Identifier type, PageContent content) {
