...
public class TierRangeMaterialSectionTransformer extends BookTransformer {
    ...
    public void transform(BookData book) {
        for (SectionData section : book.sections) {
            ...
            if (element != null) {
                try {
                    JsonObject json = net.minecraft.util.JsonHelper.asObject(element, KEY.toString());
                    ...
                    pageBuilder = typeData.getMapping(net.minecraft.util.JsonHelper.getBoolean(json, "detailed", false));
