...
public class OreMeltingRecipe extends MeltingRecipe {
    ...
    protected OreMeltingRecipe(Identifier id, String group, Ingredient input, FluidStack output, int temperature, int time, List<FluidStack> byproducts, OreRateType oreType, List<OreRateType> byproductTypes) {
