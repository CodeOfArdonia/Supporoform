...
public class MultilevelModifierRecipeBuilder extends AbstractRecipeBuilder<MultilevelModifierRecipeBuilder> {
     ...
     * @return Builder instance
     */
    public MultilevelModifierRecipeBuilder addInput(ItemConvertible item, int amount) {
     ...
     * @return Builder instance
     */
    public MultilevelModifierRecipeBuilder addInput(ItemConvertible item) {
     ...
     */
    public MultilevelModifierRecipeBuilder saveSalvage(Consumer<RecipeJsonProvider> consumer, Identifier id) {
        if (levels.isEmpty()) {
    ...
    private void writeCommon(JsonObject json) {
        ...
        if (tools == Ingredient.EMPTY) {
            ingredient = Ingredient.fromTag(TinkerTags.Items.MODIFIABLE);
        }
    ...
    private class FinishedSalvage extends AbstractFinishedRecipe {
        ...
        public FinishedSalvage(Identifier id, SlotCount slots, int minLevel, int maxLevel) {
            super(id, null);
            this.slots = slots;
