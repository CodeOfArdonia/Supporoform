...
public class MaterialIngredient extends NestedIngredient {
     ...
     */
    public static MaterialIngredient of(ItemConvertible item, MaterialVariantId material) {
        return of(Ingredient.ofItems(item), material);
    }
     ...
     * @return Material ingredient instance
     */
    public static MaterialIngredient of(ItemConvertible item, TagKey<IMaterial> tag) {
        return of(Ingredient.ofItems(item), tag);
    }
     ...
     * @return Material ingredient instance
     */
    public static MaterialIngredient of(ItemConvertible item) {
    ...
    public static MaterialIngredient of(TagKey<Item> tag, MaterialVariantId material) {
        return of(Ingredient.fromTag(tag), material);
    }
    ...
    public ItemStack[] getItems() {
        if (materialStacks == null) {
            if (!MaterialRegistry.isFullyLoaded()) {
                return nested.getMatchingStacks();
            }
            // no material? apply all materials for variants
            Stream<ItemStack> items = Arrays.stream(nested.getMatchingStacks());
            // if we have a specific material, use that
            if (!material.equals(WILDCARD)) {
                items = items.map(stack -> IMaterialItem.withMaterial(stack, this.material)).filter(ItemStack::hasNbt);
            } else {
