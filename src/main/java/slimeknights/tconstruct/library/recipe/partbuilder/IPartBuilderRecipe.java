...
public interface IPartBuilderRecipe extends ICommonRecipe<IPartBuilderContainer> {
     ...
     */
    Ingredient DEFAULT_PATTERNS = Ingredient.fromTag(TinkerTags.Items.DEFAULT_PATTERNS);
     ...
     */
    default List<Text> getText(IPartBuilderContainer inv) {
