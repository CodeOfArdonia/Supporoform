...
public class PartRecipe implements IPartBuilderRecipe, IMultiRecipe<ItemPartRecipe> {
     ...
     */
    @Override
    public boolean matches(IPartBuilderContainer inv, World world) {
        ...
        if (multiRecipes == null) {
            ...
            multiRecipes = MaterialRegistry
                    ...
                    .map(mat -> {
                        ...
                        return new ItemPartRecipe(materialId, mat.getIdentifier(), pattern, patternItem, getCost(), ItemOutput.fromStack(this.output.withMaterial(materialId)));
                    })
