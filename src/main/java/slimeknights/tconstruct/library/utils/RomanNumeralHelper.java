...
public class RomanNumeralHelper {
     ...
     */
    private static final Int2ObjectMap<Text> NUMERAL_CACHE = new Int2ObjectOpenHashMap<>();
     ...
     * @return Numeral
     */
    public static Text getNumeral(int value) {
        ...
        if (Util.canTranslate(key)) {
            component = Text.translatable(key);
        } else {
            component = Text.literal(intToRomanNumeral(value));
        }
