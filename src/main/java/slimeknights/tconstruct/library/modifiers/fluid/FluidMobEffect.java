 ...
 */
public record FluidMobEffect(StatusEffect effect, int time, int level, @Nullable List<Item> curativeItems) {
     ...
     */
    public StatusEffectInstance effectWithTime(int time) {
        StatusEffectInstance instance = new StatusEffectInstance(effect, time, this.level - 1);
     ...
     * Creates the final effect
     */
    public StatusEffectInstance makeEffect(float scale) {
    ...
    public static class Builder {
         ...
         */
        public Builder effectCure(StatusEffect effect, int time, int level, Item... curativeItems) {
         ...
         */
        public Builder effect(StatusEffect effect, int time, int level) {
         ...
         */
        public Builder effect(StatusEffect effect, int time) {
