...
public interface InventoryTickModifierHook {
     ...
     */
    void onInventoryTick(IToolStackView tool, ModifierEntry modifier, World world, LivingEntity holder, int itemSlot, boolean isSelected, boolean isCorrectSlot, ItemStack stack);
     ...
     */
    static void heldInventoryTick(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
    ...
    record AllMerger(Collection<InventoryTickModifierHook> modules) implements InventoryTickModifierHook {
        @Override
        public void onInventoryTick(IToolStackView tool, ModifierEntry modifier, World world, LivingEntity holder, int itemSlot, boolean isSelected, boolean isCorrectSlot, ItemStack stack) {
