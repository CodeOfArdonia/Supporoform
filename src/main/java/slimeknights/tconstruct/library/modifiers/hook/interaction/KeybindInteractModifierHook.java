...
public interface KeybindInteractModifierHook {
     ...
     */
    default boolean startInteract(IToolStackView tool, ModifierEntry modifier, PlayerEntity player, EquipmentSlot slot, TooltipKey keyModifier) {
        return false;
    }
     ...
     * @param slot     Slot containing the tool
     */
    default void stopInteract(IToolStackView tool, ModifierEntry modifier, PlayerEntity player, EquipmentSlot slot) {
    }
