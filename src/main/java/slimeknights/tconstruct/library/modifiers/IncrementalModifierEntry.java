...
public class IncrementalModifierEntry extends ModifierEntry {
    ...
    public NbtCompound serializeToNBT() {
        NbtCompound tag = super.serializeToNBT();
    ...
    public String toString() {
        return "IncrementalModifierEntry{" + modifier.getId() + ",level=" + level + ",amount=" + this.amount + '/' + this.needed + '}';
    }
     ...
     */
    public static Text addAmountToName(Text name, int amount, int neededPerLevel) {
