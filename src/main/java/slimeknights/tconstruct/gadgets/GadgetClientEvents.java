...
public class GadgetClientEvents extends ClientEventBase {
    ...
    static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(TinkerGadgets.glowBallEntity.get(), FlyingItemEntityRenderer::new);
        event.registerEntityRenderer(TinkerGadgets.eflnEntity.get(), FlyingItemEntityRenderer::new);
