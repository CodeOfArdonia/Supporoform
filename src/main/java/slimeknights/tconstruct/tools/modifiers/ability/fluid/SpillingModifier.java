        ...
        if (damageDealt > 0 && context.isFullyCharged()) {
            ...
            if (!fluid.isEmpty()) {
                ...
                if (recipe.hasEntityEffects()) {
                    ...
                    int consumed = recipe.applyToEntity(fluid, modifier.getEffectiveLevel(), new FluidEffectContext.Entity(living.getWorld(), living, player, null, context.getTarget(), context.getLivingTarget()), FluidAction.EXECUTE);
