...
public final class TinkerTools extends TinkerModule {
     ...
     */
    public static final ItemGroup TAB_TOOLS = new SupplierCreativeTab(TConstruct.MOD_ID, "tools", () -> TinkerTools.pickaxe.get().getRenderTool());

    /**
     * Loot function type for tool add data
     */
    public static final RegistryObject<LootFunctionType> lootAddToolData = LOOT_FUNCTIONS.register("add_tool_data", () -> new LootFunctionType(AddToolDataFunction.SERIALIZER));

    /*
     * Items
     */
    private static final Item.Settings TOOL = new Item.Settings().maxCount(1).tab(TAB_TOOLS);
    ...
    public static final ItemObject<ModifiableItem> dagger = ITEMS.register("dagger", () -> new ModifiableSwordItem(new Item.Settings().maxCount(2).tab(TAB_TOOLS), ToolDefinitions.DAGGER));
    ...
    // arrows
    public static final ItemObject<ArrowItem> crystalshotItem = ITEMS.register("crystalshot", () -> new CrystalshotItem(new Item.Settings().tab(TAB_TOOLS)));

    /* Particles */
    public static final RegistryObject<DefaultParticleType> hammerAttackParticle = PARTICLE_TYPES.register("hammer_attack", () -> new DefaultParticleType(true));
    public static final RegistryObject<DefaultParticleType> axeAttackParticle = PARTICLE_TYPES.register("axe_attack", () -> new DefaultParticleType(true));
    public static final RegistryObject<DefaultParticleType> bonkAttackParticle = PARTICLE_TYPES.register("bonk", () -> new DefaultParticleType(true));
    ...
    public static final RegistryObject<EntityType<IndestructibleItemEntity>> indestructibleItem = ENTITIES.register("indestructible_item", () ->
            EntityType.Builder.<IndestructibleItemEntity>create(IndestructibleItemEntity::new, SpawnGroup.MISC)
                    .setDimensions(0.25F, 0.25F)
                    .makeFireImmune());
    public static final RegistryObject<EntityType<CrystalshotEntity>> crystalshotEntity = ENTITIES.register("crystalshot", () ->
            EntityType.Builder.<CrystalshotEntity>create(CrystalshotEntity::new, SpawnGroup.MISC)
                    .setDimensions(0.5F, 0.5F)
                    .maxTrackingRange(4)
                    .trackingTickInterval(20));

    /* Containers */
    public static final RegistryObject<ScreenHandlerType<ToolContainerMenu>> toolContainer = MENUS.register("tool_container", ToolContainerMenu::forClient);
