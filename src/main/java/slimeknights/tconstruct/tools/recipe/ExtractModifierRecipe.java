...
public class ExtractModifierRecipe extends ModifierRemovalRecipe {
    ...
    private static final Text DESCRIPTION = TConstruct.makeTranslation("recipe", "extract_modifier.description");
    private static final Text NO_MODIFIERS = TConstruct.makeTranslation("recipe", "extract_modifier.no_modifiers");
