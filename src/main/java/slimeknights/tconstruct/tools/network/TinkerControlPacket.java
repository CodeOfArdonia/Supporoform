...
public enum TinkerControlPacket implements IThreadsafePacket {
    ...
    public static TinkerControlPacket read(PacketByteBuf buffer) {
        return buffer.readEnumConstant(TinkerControlPacket.class);
    }

    @Override
    public void encode(PacketByteBuf packetBuffer) {
        packetBuffer.writeEnumConstant(this);
    }
